...
class ColorHelperFileIndexCommand(sublime_plugin.TextCommand):
    ...
    def run(self, edit, scan_scopes=None, allowed_colors=("all",), use_hex_argb=False):
        """Run the command."""
        if scan_scopes:
